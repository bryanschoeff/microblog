...
describe User do
  ...
  before do
    @user = User.new(name: "Test Person", email: "test@gmail.com",
  ...
  describe "when the email format is valid" do
    it "should be valid" do
      addresses = %w[user@foo.com A_USER@f.b.com a+b@baz.cn]
      addresses.each do |address|
        @user.email = address
  ...
  describe "when password does not macth confirmation" do
    before { @user.password_confirmation = "baz" }
    it { should_not be_valid }
  end
